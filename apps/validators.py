...
def check_keywords_python(keys):
	"""
...
if __name__ == '__main__':
	...
	keys = ["for", "while", "tanisha", "break", "sky",
		"elif", "assert", "pulkit", "lambda", "else", "sakshar"]
	check_keywords_python(keys)

	check_password("Vanilton!8@")

	check_valid_identifier("_123")
